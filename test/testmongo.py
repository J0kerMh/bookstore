...
------------      -------    --------    -----------
2019/12/29 14:33   wycai      1.0         None
'''
...
def test_mongo():
    ...
    picture=["123","456","12323kjk"]
    book_id=123,
    insert_book_Mongo(123,author_intro,book_intro,context,tags,picture)

def test_index():
    searcher=search()
    result=searcher.search_index("tags","圣经")
    temprr=result[0].get("Mongo_ID")
